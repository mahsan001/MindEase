    ...
    return (
        <footer className="bg-secondary text-white pt-16 pb-8 px-6">
            <div className="max-w-[1400px] mx-auto grid grid-cols-1 md:grid-cols-3 gap-16 mb-10">
                <div>
                    <h3 className="font-heading text-xl mb-5 text-primary">About MindEase</h3>
                ...
                <div>
                    <h3 className="font-heading text-xl mb-5 text-primary">Quick Links</h3>
                ...
                <div>
                    <h3 className="font-heading text-xl mb-5 text-primary">Resources</h3>
                    <ul className="space-y-3">
